...
module.exports = { 
    SESSION_ID: process.env.SESSION_ID || 'kord_ai-SzJjDsSk5hsHdjxZ',
    ...
    STICKER_PACKNAME: process.env.STICKER_PACKNAME || "GAGA-MD",
    ...
    BOT_NAME: process.env.BOT_NAME || "GAGA-MD",
    ...
    AUDIO_DATA: process.env.AUDIO_DATA || "Gaga;🤍",
